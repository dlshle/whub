...
func (h *ClientMessageHandler) NewClientMessageHandler(ctx *relay_common.WRContext, manager relay_server.IClientManager) IServerMessageHandler {
	return &ClientMessageHandler{ctx, manager}
}

func (h *ClientMessageHandler) Handle(message *messages.Message, next NextMessageHandler) (*messages.Message, error) {
...
func (h *ClientMessageHandler) Priority() int {
	return HandlerPriorityClientMessage
}
